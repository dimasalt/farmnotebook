...
-- Dumping data for table farmwork.contact: ~41 rows (approximately)
INSERT INTO `contact` (`id`, `name`, `address`, `phone`, `email`, `note`, `type`, `created_at`) VALUES
	...
	('735509ba-baf5-11ed-989d-d8cb8ac0caec', 'test', 'test', NULL, NULL, 'test', 2, '2023-03-04 20:31:28'),
...
-- Dumping data for table farmwork.transaction: ~95 rows (approximately)
...
-- Dumping data for table farmwork.transaction_item: ~187 rows (approximately)
